...
public class baitap4_2 {
    public static void main(String[] args) {
        ...
        System.out.println("Hãy nhập số nguyên có 3 chữ số vào đây để đọc: ");
        int number = infor.nextInt();
        while (number >= 1000 || number < 0){
            System.out.println("Uứng dụng chỉ đọc đc các số nguyên dương có 3 chữ số; vui lòng bật lại: ");
